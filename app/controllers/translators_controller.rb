class TranslatorsController < ApplicationController
  ...
  private
    ...
    def translator_params
      params.require(:translator).permit(:first_name, :last_name, :screen_name, :profession, :other_qualifications, :rate_per_minute, :email, :salt, :encrypted_password, :phone_number, :cc#, :cc_expiration, :cvv2, :zipcode, :overall_rating, :total_transactions, :created_at, :updated_at)
    end
end
